...
#define MS_MULTIPLY(C1,C2,C3) template<typename T> void MatrixSp<T,C1,C2,C3>::multiply(const Matrix<T, C1, C2>& lhs, const Matrix<T, C2, C3>& rhs, Matrix<T, C1, C3>& result){\
